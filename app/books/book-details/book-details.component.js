...
var BookDetailsComponent = (function () {
    function BookDetailsComponent(_route, _bookscrvice) {
        this._route = _route;
        this._bookscrvice = _bookscrvice;
    ...
    BookDetailsComponent.prototype.getBook = function (id) {
        var _this = this;
        this._bookscrvice.getbook(id).subscribe(function (books) { return _this.book = books; }, function (error) { return _this.errormessage = error; });
    };
